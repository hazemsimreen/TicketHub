...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260815041624_AddRole4Collaboration")]
    partial class AddRole4Collaboration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccess.Models.Rating", b =>
                {
                    ...
                    b.ToTable("Ratings", null, t =>
                        {
                            t.HasCheckConstraint("CK_Rating_Stars_Range", "[Stars] BETWEEN 1 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Models.WorkflowStep", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            RoleId = 2,
                            StepOrder = 1,
                            WorkflowDefinitionId = new Guid("11111111-0000-0000-0000-000000000002")
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("23333333-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsDeleted = false,
                            RoleId = 2,
                            StepOrder = 1,
                            WorkflowDefinitionId = new Guid("11111111-0000-0000-0000-000000000003")
                        },
                        new
                        {
                            Id = new Guid("23333333-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsDeleted = false,
                            RoleId = 3,
                            StepOrder = 2,
            ...
            modelBuilder.Entity("DataAccess.Models.Attachment", b =>
                {
                    ...
                    b.HasOne("DataAccess.Models.User", "UploadedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccess.Models.Rating", b =>
                {
                    b.HasOne("DataAccess.Models.User", "RatedByUser")
                        .WithMany()
